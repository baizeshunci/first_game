...
public class CharacterStats : MonoBehaviour
{
    ...
    public Stat intelligence; // 1 point inrease magic damage by 1 and magic resistance by 3 �ǻ�
    public Stat vitality; // 1 point increase health by 3 or 4 points ����
    ...
    public Stat maxHP;  //��Ѫ
    public Stat armor; // װ�� defence 
    public Stat evasion; //���� miss
    ...
    protected int CheckTargetTotalArmor(CharacterStats _targetStats, int totalDamage)
    {
    ...
    protected int CalculteCriticalDamage(int _damage)
    {
