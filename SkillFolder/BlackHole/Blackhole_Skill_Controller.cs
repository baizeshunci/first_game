...
public class Blackhole_Skill_Controller : MonoBehaviour
{
    ...
    private float maxSize =12;
    private float growSpeed =6;
    ...
    [SerializeField] private List<GameObject> createHotKey = new List<GameObject>();
    ...
    private void CloneAttackLogic()
    {
        if (cloneAttackTimer < 0 && cloneAttackReleased && amountOfAttacks > 0)
        {
            ...
            {
                SkillManager.instance.clone.CreateClone(targets[randomIndex], new Vector3(xOffset, -0.67f), 2);
            }
            amountOfAttacks--;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if(collision.GetComponent<Enemy>()!=null)
        {
            ...
            //respawn prefab of aht key above enemy
    ...
    private void CreateHotKey(Collider2D collision)
    {
        ...
        Blankhole_HotKey_Controller newHotKeyScript = newHotKey.GetComponent<Blankhole_HotKey_Controller>();
